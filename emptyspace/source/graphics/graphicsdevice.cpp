...
Texture* GraphicsDevice::CreateTexture(const u32 internalFormat, const u32 format, const s32 width, const s32 height, void* data, const u32 filter, const u32 repeat)
{
	return new Texture(internalFormat, format, width, height, data, filter, repeat);
}